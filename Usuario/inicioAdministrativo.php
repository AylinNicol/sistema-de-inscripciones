            ...
            <div class="contenedor">
                <div class="row d-flex h-100">
                    <div class="col-sm-8 text-center justify-content-center align-self-center">
                        <h2>
                            ¡Empieza a visualizar y generar la información hoy mismo!
                        </h2>
                        <p> Este sistema te permite acceder a la información de forma eficiente. <br>
                            Accede al sistema desde cualquier ordenador con conexión a Internet.<br>
                            Para más información presiona...
                            </p>
                        <a href="ayudaAdministrativo.php" class="btn">
                            LEER MÁS...
                        </a>
                    </div>
                    <div class="col-sm-4">
      ...
      <div class="contenedor">
        <div class="row text-center">
          <div class="col ml-auto">
            <h3>¿Cómo empezar?</h3>
            <p>Desplaza el puntero en el menú ubicado en la sección izquierda. Comienza a visualizar y generar la información.</p>
