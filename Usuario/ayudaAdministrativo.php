...
<body> 
    ...
    <!--MENU-->
    <?php require "../Vistas/MenuAdministrativo.php"?>
    <!--AYUDA-->
    <div class="ayuda">
            ...
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne"
                  ...
                  <span class="accordion-label">INICIO DE SESIÓN</span>
                </button>
              </h2>
              <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                data-bs-parent="#accordionAyuda">
                <div class="accordion-body">
                  <h2 class="accordion-subtitle">1. ¿Cómo puedo iniciar sesión como administrativo?</h2>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
                  ...
                  <i class="bi bi-person-fill"></i>
                  <span class="accordion-label">CUENTA</span>
                </button>
              </h2>
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingThree"
                ...
                <div class="accordion-body">
                  ...
                  <div class="accordion-text">Debe realizar la solicitud a un usuario que sea organizador.</div>
                  <h2 class="accordion-subtitle">2. ¿Cómo cambiar mi información personal?</h2>
                  <div class="accordion-text">Si desea cambiar su información en algún campo, se tiene realizar la solicitud a un 
                    usuario que sea organizador.</div>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree"
                  ...
                  <span class="accordion-label">GENERACIÓN DE REPORTES</span>
                </button>
              </h2>
              <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                ...
                <div class="accordion-body">
                  ...
                  <div class="accordion-text">En el menú podrá seleccionar la opción de la cual desea el reporte. 
            ...
            <div class="accordion-item">
              <h2 class="accordion-header">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour"
                  ...
                  <span class="accordion-label">CAMBIAR CONTRASEÑA DE USUARIO</span>
                </button>
              </h2>
              <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                data-bs-parent="#accordionAyuda">
                <div class="accordion-body">
                  <h2 class="accordion-subtitle">1. ¿Cómo puedo cambiar mi contraseña de usuario?</h2>
                  <div class="accordion-text">Debe realizar la solicitud a un usuario que sea organizador. Donde le solicitará  
                    la contraseña actual para luego pedirle la nueva contraseña.</div>
                </div>
              </div>
            </div>
            <div class="accordion-item">
              ...
              <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                data-bs-parent="#accordionAyuda">
                <div class="accordion-body">
                  <h2 class="accordion-subtitle">1. ¿Cómo se protege mi contraseña?</h2>
                  <div class="accordion-text">Existe seguridad a través del encriptado de la contraseña</div>
                  <h2 class="accordion-subtitle">2. ¿Quiénes pueden ver todos los datos?</h2>
